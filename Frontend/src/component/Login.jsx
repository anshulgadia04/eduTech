  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      .then((res)=>{
        ...
        // res.data.token.split('.')[1]   it is used to extract the payload from jwt token because it is at index 1
        //  atob() it is used to decode the payload Base URL


        if(decodedToken.isAdmin)
        {
          setIsAdmin(true)
          toast.success(`Admin ${res.data.message}`);
          setTimeout(() => {
            navigate('/admin')
          }, "100");
      ...
      <div class="font-[sans-serif]">
        <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
          <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            <div>
              <h2 class="lg:text-3xl text-4xl font-extrabold lg:leading-[55px] text-gray-800">
              Welcome back! Unlock a world of knowledge with our simple and
              ...
              <p class="text-sm mt-12 text-gray-800">
                ...
                <Link
                  className="text-blue-500 text-xl font-bold hover:underline hover:duration-300"
                  to={"/signup"}
                >
                  Register here
                </Link>
