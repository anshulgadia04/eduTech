...
function CPP() {
  ...
  <div class="container mx-auto px-6 flex relative py-16">
    <div class="sm:w-2/3 lg:w-1/2 flex flex-col relative z-20">
      <div class="text-6xl sm:text-4xl font-black flex flex-col leading-none text-gray-800">
        <div class="flex flex-row gap-5 mb-5">
          ...
          />
          <h2 class="items-center justify-center">C++ Programming Course</h2>
        </div>
      </div>
      <p class="text-sm sm:text-base text-blue-500">
        Dive into C++, the language that powers complex systems, game engines, and more.
      </p>
    ...
    <div class="sm:flex sm:justify-center sm:items-center sm:w-1/3 lg:w-1/2 relative">
      <iframe
        src="https://www.youtube.com/embed/vLnPwxZdW4Y?autoplay=1&mute=1"
  ...
  <div class="w-1/2 m-auto">
    <div class="w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
      ...
      <div class="py-5 text-center">
        ...
        <p class="text-white">Michael Lee</p>
      </div>
    </div>
  </div>
...
<div class="w-[80%] m-auto flex justify-between">
  <div class="w-1/2">
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5 flex items-center">
      ...
      <div class="text-gray-800">Familiarity with C++ syntax</div>
    </div>
  </div>
  ...
  <div class="w-1/2">
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Introduction to C++</div>
      </div>
      <p class="ml-14 text-gray-500">Learn the basics of C++, including setup, syntax, and writing simple programs.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Object-Oriented Programming in C++</div>
      </div>
      <p class="ml-14 text-gray-500">Master OOP concepts in C++, including classes, objects, and inheritance.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Advanced C++ Concepts</div>
      </div>
      <p class="ml-14 text-gray-500">Explore advanced topics like templates, STL, and multi-threading in C++.</p>
    </div>
  </div>
</div>
