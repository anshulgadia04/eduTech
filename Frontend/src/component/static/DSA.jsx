...
function DSA() {
  ...
  <div class="container mx-auto px-6 flex relative py-16">
    <div class="sm:w-2/3 lg:w-1/2 flex flex-col relative z-20">
      <div class="text-6xl sm:text-4xl font-black flex flex-col leading-none text-gray-800">
        <div class="flex flex-row gap-5 mb-5">
          <img
            class="w-14"
            src="https://cdn.codechef.com/images/self-learning/icons/dsa.svg"
          />
          <h2 class="items-center justify-center">Data Structures & Algorithms</h2>
        </div>
      </div>
      <p class="text-sm sm:text-base text-blue-500">
        Learn the core concepts of Data Structures & Algorithms and excel in coding interviews.
      </p>
      ...
      <h1 class="text-2xl my-5">
        Course Price <span class="font-extrabold">$349.99</span>
      </h1>
      <div class="flex">
        <a
    ...
    <div class="sm:flex sm:justify-center sm:items-center sm:w-1/3 lg:w-1/2 relative">
      <iframe
        src="https://www.youtube.com/embed/bum_19loj9A?autoplay=1&mute=1"
...
<div class="w-[80%] m-auto mb-20 flex justify-between">
  <div class="w-1/2 m-auto">
    <div class="w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
      <img
        class="object-cover w-full h-56"
        src="https://images.unsplash.com/photo-1573495804683-efbcbadce487?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
        alt="Instructor Avatar"
      />

      <div class="py-5 text-center">
        <p class="text-white">Instructor</p>
      ...
      <div class="flex items-center px-5 py-6 shadow-sm rounded-md">
        ...
        <div class="mx-5">
          <h4 class="text-2xl font-semibold text-blue-500">
            Earn a certificate after completing all the lessons.
          </h4>
        </div>
      </div>
    </div>
...
<div class="w-[80%] m-auto flex justify-between">
  <div class="w-1/2">
    <h2 class="text-2xl font-bold">Prerequisites</h2>

    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5 flex items-center">
      <div class="bg-[#DFE3E7] text-black text-opacity-70 rounded-full w-10 h-10 flex items-center justify-center mr-4">
        1
      </div>
      <div class="text-gray-800">Basic programming skills</div>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5 flex items-center">
      ...
      <div class="text-gray-800">Understanding of basic algorithms</div>
    </div>
  </div>
  ...
  <div class="w-1/2">
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        <div class="bg-[#DFE3E7] text-black text-opacity-70 rounded-full w-10 h-10 flex items-center justify-center mr-4">
          1
        </div>
        <div class="text-gray-800 font-bold">Introduction to Data Structures</div>
      </div>
      <p class="ml-14 text-gray-500">Understanding different types of data structures, their applications, and implementation.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Algorithm Design & Analysis</div>
      </div>
      <p class="ml-14 text-gray-500">Learn the principles of algorithm design and how to analyze their efficiency.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Advanced Algorithms</div>
      </div>
      <p class="ml-14 text-gray-500">Explore advanced algorithms including graph algorithms, dynamic programming, and more.</p>
    </div>
  </div>
</div>
