...
function Python() {
  ...
  <div class="container mx-auto px-6 flex relative py-16">
    <div class="sm:w-2/3 lg:w-1/2 flex flex-col relative z-20">
      <div class="text-6xl sm:text-4xl font-black flex flex-col leading-none text-gray-800">
        <div class="flex flex-row gap-5 mb-5">
          ...
          />
          <h2 class="items-center justify-center">Python Programming Course</h2>
        </div>
      </div>
      <p class="text-sm sm:text-base text-blue-500">
        Learn Python, the versatile language loved by developers for its simplicity and power.
      </p>
      ...
      <h1 class="text-2xl my-5">
        Course Price <span class="font-extrabold">$199.99</span>
      </h1>
      <div class="flex">
        <a
    ...
    <div class="sm:flex sm:justify-center sm:items-center sm:w-1/3 lg:w-1/2 relative">
      <iframe
        src="https://www.youtube.com/embed/rfscVS0vtbw?autoplay=1&mute=1"
  ...
  <div class="w-1/2 m-auto">
    <div class="w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
      <img
        ...
        src="https://images.unsplash.com/photo-1523413744501-fd84a7db1df9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
        alt="Instructor Avatar"
      />

      <div class="py-5 text-center">
        <p class="text-white">Instructor</p>
        <p class="text-white">Jane Smith</p>
      </div>
    </div>
  </div>
...
<div class="w-[80%] m-auto flex justify-between">
  <div class="w-1/2">
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5 flex items-center">
      ...
      <div class="text-gray-800">Basic understanding of programming concepts</div>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5 flex items-center">
      ...
      <div class="text-gray-800">Willingness to learn and practice</div>
    </div>
  </div>
  ...
  <div class="w-1/2">
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Introduction to Python</div>
      </div>
      <p class="ml-14 text-gray-500">Getting started with Python, setting up the environment, and writing your first script.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Data Structures in Python</div>
      </div>
      <p class="ml-14 text-gray-500">Learn about lists, dictionaries, tuples, and sets, and how to use them effectively in Python.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Object-Oriented Programming in Python</div>
      </div>
      <p class="ml-14 text-gray-500">Exploring the concepts of classes, objects, inheritance, and more in Python.</p>
    </div>
  </div>
</div>
