...
<div class="bg-white flex relative z-20 items-center overflow-hidden">
  <div class="container mx-auto px-6 flex relative py-16">
    <div class="sm:w-2/3 lg:w-1/2 flex flex-col relative z-20">
      <div class="text-6xl sm:text-4xl font-black flex flex-col leading-none text-gray-800">
        <div class="flex flex-row gap-5 mb-5">
          <img
            class="w-14"
            src="https://cdn.codechef.com/images/self-learning/icons/java.svg"
          />
          <h2 class="items-center justify-center">Java Programming Course</h2>
        </div>
      </div>
      <p class="text-sm sm:text-base text-blue-500">
        Master the fundamentals of Java programming, one of the most popular programming languages.
      </p>
      ...
      <h1 class="text-2xl my-5">
        Course Price <span class="font-extrabold">$299.99</span>
      </h1>
      <div class="flex">
        <a
    ...
    <div class="sm:flex sm:justify-center sm:items-center sm:w-1/3 lg:w-1/2 relative">
      <iframe
        src="https://www.youtube.com/embed/grEKMHGYyns?autoplay=1&mute=1"
  ...
  <div class="w-1/2 m-auto">
    <div class="w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
      <img
        ...
        src="https://images.unsplash.com/photo-1581091870621-48d46c0c5f53?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
...
<div class="w-[80%] m-auto flex justify-between">
  <div class="w-1/2">
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5 flex items-center">
      ...
      <div class="text-gray-800">Basic knowledge of programming</div>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5 flex items-center">
      ...
      <div class="text-gray-800">Familiarity with object-oriented concepts</div>
    </div>
  </div>
  ...
  <div class="w-1/2">
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Introduction to Java</div>
      </div>
      <p class="ml-14 text-gray-500">Understanding the basics of Java, setting up the environment, and writing your first program.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Object-Oriented Programming</div>
      </div>
      <p class="ml-14 text-gray-500">Learning about classes, objects, inheritance, polymorphism, and encapsulation.</p>
    </div>
    ...
    <div class="w-3/4 bg-[#F7F9FA] border border-gray-200 shadow-md rounded-md p-3 my-5">
      <div class="flex items-center">
        ...
        <div class="text-gray-800 font-bold">Advanced Java Concepts</div>
      </div>
      <p class="ml-14 text-gray-500">Exploring multithreading, exception handling, and collections framework.</p>
    </div>
  </div>
</div>
