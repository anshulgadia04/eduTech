        ...
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            <div class="w-full">
                ...
                <div class="pt-11 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
                    ...
                    <p class="font-normal text-lg leading-8 text-gray-400 max-xl:text-justify">I absolutely love EduTech! Finding quality courses in my native language, Marathi, has been a game-changer for me. The content is easy to understand, and the instructors explain everything so clearly. It’s great that EduTech is providing courses in so many regional languages, making learning accessible for everyone. Highly recommend it to anyone who prefers learning in their own language!</p>
                </div>
                <div class="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
                    ...
                    <h3 class="font-manrope font-semibold text-xl sm:text-2xl leading-9 text-black mb-6">Superb
                    </h3>
                    <div class="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                        <div class="flex items-center gap-3">
                            <img src="https://pagedone.io/asset/uploads/1704351103.png" alt="Robert image" class="w-8 h-8 rounded-full"/>
                            <h6 class="font-semibold text-lg leading-8 text-indigo-600">Robert Karmazov</h6>
                        </div>
                        <p class="font-normal text-lg leading-8 text-gray-400">Nov 01, 2023</p>
                    </div>
                    <p class="font-normal text-lg leading-8 text-gray-400 max-xl:text-justify">EduTech has made learning so much easier for me! As a student from a rural area, I struggled to find educational resources in my local language, Telugu. With EduTech, I can now study complex subjects without worrying about language barriers. The variety of courses available in different regional languages is amazing. It’s truly a platform for everyone!</p>
                </div>
